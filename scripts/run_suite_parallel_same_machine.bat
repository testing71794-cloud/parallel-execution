...
echo [INFO] One ADB warm-up; nonprinting runs parallel per device, printing runs sequential per device.
echo [INFO] Each run uses explicit device id: maestro --device ^<serial^> test ^<flow^>
